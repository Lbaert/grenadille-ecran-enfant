...
import type { SimulationData } from "@/utils/impactCalculator";
...
export const EmailCollection = ({ onEmailSubmit, onBack, simulationData }: EmailCollectionProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://hook.eu2.make.com/ah8meuzp5da4e6cuprmi7dghfxwalson', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          source: 'cout-ecrans-tool',
          childAge: simulationData.childAge,
          screenTimeHours: simulationData.screenTimeHours,
          mainDevices: simulationData.mainDevices
        })
      });
